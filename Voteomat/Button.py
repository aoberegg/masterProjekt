...
class Button:
    ...
    def __init__(self, (x, y), gui, start_image, func = None, stay_depressed = False, height = 70, width = 120):
    ...
    def draw_button(self):
        ...
        if not self.gui.clicked[self]:
            ...
            color = unpressed
            negative = pressed
        pygame.draw.rect(self.gui.window, (0,0,0), (self.x, self.y, self.width, self.height))
